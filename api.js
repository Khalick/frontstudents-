async function login() {
    ...
    if (registrationNumber && password) {
        // For testing/demo purposes: allow a hardcoded login when backend is unavailable
        if (registrationNumber === 'demo' && password === 'demo123') {
            localStorage.setItem('token', 'demo-token-12345');            localStorage.setItem('currentUser', 'Demo Student');
            localStorage.setItem('studentId', 'DEMO001');
            localStorage.setItem('registrationNumber', 'CLIP/2023/DEMO');
            
            document.getElementById('loginStatus').textContent = 'Demo login successful! Redirecting...';
